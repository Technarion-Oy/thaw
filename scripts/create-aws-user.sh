...
aws iam attach-user-policy --user-name github-actions-user-for-release-notes --policy-arn arn:aws:iam::$AWS_ACCOUNT_ID:policy/s3-access-for-github-user-release
