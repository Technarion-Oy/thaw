...
- Browse all databases → schemas → tables, views, materialized views, dynamic tables, external tables, iceberg tables, functions, procedures, sequences, stages, streams, tasks, alerts, tags, file formats, pipes, notebooks, secrets, and git repositories
