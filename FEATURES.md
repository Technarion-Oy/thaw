...
- Browse all databases → schemas → tables, views, materialized views, dynamic tables, external tables, functions, procedures, sequences, stages, streams, tasks, alerts, file formats, pipes, notebooks, secrets, and git repositories
