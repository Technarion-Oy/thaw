...
- Browse all databases → schemas → tables, views, materialized views, dynamic tables, external tables, functions, procedures, sequences, stages, streams, tasks, alerts, tags, file formats, pipes, notebooks, secrets, and git repositories
...
- **Alert Management** — right-click any schema and choose **Create Object** → **Alert…**, or right-click an existing alert (listed under the **Alerts** group) for alert-specific operations:
...
- **Tag Management** — right-click any schema and choose **Create Object** → **Tag…**, or right-click an existing tag (listed under the **Tags** group) for governance-tag operations:
...
- **Masking Policy Management** — right-click any schema and choose **Create Object** → **Masking Policy…**, or right-click an existing policy (listed under the **Masking Policies** group) for column-level governance operations:
...
- **Network Rule Management** — right-click any schema and choose **Create Object** → **Network Rule…**, or right-click an existing rule (listed under the **Network Rules** group) for network-access operations:
