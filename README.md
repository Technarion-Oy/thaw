...
- Right-click an **object** to:
  ...
  - **Insert Mapping** — select a table as an **Insert Target** and another table or view as an **Insert Source** to open a column mapping dialog; automatically matches columns by name, identifies type mismatches (with **Add CAST** support), and warns about nullability conflicts (with **Add COALESCE** support)
