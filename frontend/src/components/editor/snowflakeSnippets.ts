...
export function getSnowflakeSnippets(monaco: typeof monacoLib): monacoLib.languages.CompletionItem[] {
  ...
  return [
    ...
    },
    {
      ...
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
      documentation: "Snowflake Scripting simple CASE statement (compares one expression against values)",
      range: range as any,
    },
    {
      label: "case_when",
      ...
      insertText: [
        "CASE",
        "  WHEN ${1:condition_1} THEN",
        "    ${2:statement;}",
        "  WHEN ${3:condition_2} THEN",
        "    ${4:statement;}",
        "  ELSE",
        "    ${5:statement;}",
        "END CASE;",
      ...
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
      documentation: "Snowflake Scripting searched CASE statement (evaluates a boolean condition per branch)",
      range: range as any,
    },
...
export const SNIPPET_CATEGORIES: {
  ...
  {
    header: "Conditionals",
    labels: ["if", "case", "case_when"],
    titles: {
      case:      "case (simple)",
      case_when: "case (searched)",
    },
  },
