...
const KIND_VAR: Record<string, string> = {
  ...
  "JOIN POLICY": "--icon-joinpolicy",
  "PRIVACY POLICY": "--icon-privacypolicy",
  "STORAGE LIFECYCLE POLICY": "--icon-storagelifecyclepolicy",
  "PASSWORD POLICY": "--icon-passwordpolicy",
  ...
  "PACKAGES POLICY": "--icon-packagespolicy",
  ...
  MODEL:             "--icon-model",
  "MODEL MONITOR":   "--icon-modelmonitor",
...
const KIND_ICON: Record<string, React.ComponentType<{ style?: React.CSSProperties }>> = {
  ...
  "JOIN POLICY": DisconnectOutlined,
  "PRIVACY POLICY": SecurityScanOutlined,
  "STORAGE LIFECYCLE POLICY": HddOutlined,
  "PASSWORD POLICY": SafetyCertificateOutlined,
  ...
  "PACKAGES POLICY": CodeSandboxOutlined,
  ...
  MODEL:            RobotOutlined,
  "MODEL MONITOR":  LineChartOutlined,
  DATASET:          DotChartOutlined,
