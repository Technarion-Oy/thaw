...
export namespace snowflake {
	...
	export class SearchAccountResult {
	    objects: SnowflakeObject[];
	    cappedKinds: string[];
	
	    static createFrom(source: any = {}) {
	        return new SearchAccountResult(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.objects = this.convertValues(source["objects"], SnowflakeObject);
	        this.cappedKinds = source["cappedKinds"];
	    }
...
export namespace table {
	...
	export class InsertRowValue {
	    ...
	    static createFrom(source: any = {}) {
	        return new InsertRowValue(source);
	    }
	...
	export class InsertRowConfig {
	    values: InsertRowValue[];
	
	    static createFrom(source: any = {}) {
	        return new InsertRowConfig(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.values = this.convertValues(source["values"], InsertRowValue);
	    }
	...
	export class InsertRowsConfig {
	    rows: InsertRowConfig[];
	
	    static createFrom(source: any = {}) {
	        return new InsertRowsConfig(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.rows = this.convertValues(source["rows"], InsertRowConfig);
	    }
