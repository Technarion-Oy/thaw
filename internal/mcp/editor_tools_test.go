...
func TestGetCurrentEditorSQLEmpty(t *testing.T) {
	...
	srv := buildServer(nil, ExecutionModeMetadata, SessionConfig{}, store, nil)
...
func TestGetQueryResultsSummaryEmpty(t *testing.T) {
	...
	srv := buildServer(nil, ExecutionModeReadonly, SessionConfig{}, store, nil)
...
func TestEditorToolsRegisteredInAllModes(t *testing.T) {
	...
	for _, mode := range modes {
		srv := buildServer(nil, mode, SessionConfig{}, store, nil)
		names := toolNames(t, srv)
