...
| `git.go` | Git repository browsing, filtering, config persistence, and **index staging** (`GitStageFile`/`GitUnstageFile`/`GitStageAll`/`GitUnstageAll`/`GitDiscardFile`); delegates to `internal/gitrepo`. |
