...
// DYNAMIC TABLE, EXTERNAL TABLE, MATERIALIZED VIEW, ALERT, FUNCTION, PROCEDURE,
// SEQUENCE, STAGE, STREAM, TASK, FILE FORMAT, PIPE.
...
// MATERIALIZED VIEW, ALERT, FUNCTION, PROCEDURE, SEQUENCE, STAGE, STREAM, TASK,
