...
func ClientDrivers() []ClientDriver {
	return []ClientDriver{
		...
		{Token: "JAVASCRIPT_DRIVER", VersionGoverned: true, VersionInfoAliases: []string{"JavaScript", "NodejsDriver", "Nodejs", "Node.js"}},
		...
		{Token: "PHP_DRIVER", VersionGoverned: true, VersionInfoAliases: []string{"PDO", "PHP", "PHPPDODriver"}},
