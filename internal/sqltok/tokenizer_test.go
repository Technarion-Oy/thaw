...
func TestTokenKinds(t *testing.T) {
	tests := []struct {
		...
		{"file uri is not comment", "file:///tmp", []TokenKind{Keyword, Colon, Operator, Operator, Operator, Identifier, EOF}},
		{"s3 uri is not comment", "s3://b", []TokenKind{Identifier, Colon, Operator, Operator, Identifier, EOF}},
