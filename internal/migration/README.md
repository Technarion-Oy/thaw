...
- DDL comparison is done after `normalizeDDL`: strips block/line comments, collapses whitespace, uppercases, and strips trailing semicolons to avoid false positives from cosmetic formatting differences.
