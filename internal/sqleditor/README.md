...
| `antipatterns.go` | `ValidateAntiPatterns` — semantic checks the grammar can't perform (MERGE clause-action validity, QUALIFY placement, FLATTEN/LATERAL usage, variant-path traversal, unknown Cortex functions) |
