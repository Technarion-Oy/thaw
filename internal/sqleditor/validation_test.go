...
func TestValidateSnowflakePatterns_ValidQueries(t *testing.T) {
	validQueries := []string{
		...
		// CREATE REPLICATION GROUP — valid
		"CREATE REPLICATION GROUP my_rg OBJECT_TYPES = DATABASES ALLOWED_DATABASES = db1 ALLOWED_ACCOUNTS = myorg.account1",
		"CREATE REPLICATION GROUP my_rg OBJECT_TYPES = ROLES, WAREHOUSES ALLOWED_ACCOUNTS = org1.acct1",
		"CREATE REPLICATION GROUP my_rg OBJECT_TYPES = DATABASES, INTEGRATIONS ALLOWED_DATABASES = db1 ALLOWED_INTEGRATION_TYPES = SECURITY INTEGRATIONS ALLOWED_ACCOUNTS = org1.acct1",
		"CREATE REPLICATION GROUP my_rg OBJECT_TYPES = DATABASES ALLOWED_DATABASES = db1 ALLOWED_ACCOUNTS = org1.acct1 IGNORE EDITION CHECK",
		"CREATE REPLICATION GROUP my_rg OBJECT_TYPES = ROLES ALLOWED_ACCOUNTS = org1.acct1 REPLICATION_SCHEDULE = '10 MINUTE'",
		// CREATE FAILOVER GROUP — valid
		...
		// ALTER REPLICATION GROUP — valid
		"ALTER REPLICATION GROUP my_rg ADD org1.acct2",
		"ALTER REPLICATION GROUP my_rg MOVE DATABASES db1 TO REPLICATION GROUP other_rg",
		"ALTER REPLICATION GROUP my_rg SET REPLICATION_SCHEDULE = '10 MINUTE'",
		"ALTER REPLICATION GROUP my_rg RENAME TO new_rg",
		// ALTER FAILOVER GROUP — valid
		...
		// DROP REPLICATION / FAILOVER GROUP — valid
