...
func TestValidateSnowflakePatterns_ValidQueries(t *testing.T) {
	validQueries := []string{
		...
		"CREATE SESSION POLICY my_session_policy SESSION_IDLE_TIMEOUT_MINS = 999999",
...
func TestValidateSnowflakePatterns_InvalidQueries(t *testing.T) {
	tests := []struct {
		...
		{"Session Policy idle timeout above range", "CREATE SESSION POLICY my_policy SESSION_IDLE_TIMEOUT_MINS = 1000000", "out of range"},
		{"Session Policy UI idle timeout below range", "CREATE SESSION POLICY my_policy SESSION_UI_IDLE_TIMEOUT_MINS = -1", "out of range"},
		{"Session Policy UI idle timeout above range", "CREATE SESSION POLICY my_policy SESSION_UI_IDLE_TIMEOUT_MINS = 1000000", "out of range"},
