...
var sqlAllKeywords = map[string]bool{
	...
	// Snowflake Cortex AI namespace identifiers
	"SNOWFLAKE": true, "CORTEX": true,
	"COMPLETE": true, "EXTRACT_ANSWER": true, "SENTIMENT": true, "SUMMARIZE": true, "TRANSLATE": true,
	"CLASSIFY_TEXT": true, "EMBED_TEXT_768": true, "EMBED_TEXT_1024": true, "FINETUNE": true,
	"SEARCH_PREVIEW": true, "TRY_COMPLETE": true,
	// Data types
